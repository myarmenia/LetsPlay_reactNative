...
const Price = (props) => {
    ...
    return (
       <View style={{...styles.priceBlock ,  width: width || RW(124)}}><Text style={styles.priceText}>Сумма оплаты </Text><TextInput style={styles.priceInput} value={value} onChangeText={(ev) => {
           setValue(ev);
