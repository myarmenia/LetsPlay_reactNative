...
function Index({user, onPress, size, item}) {
    console.log()
    ...
    return (
        <View style={{
            ...
            >
                <View
                    style={{...style.titleBloc, width: size / RW(6), height: size / RH(14), marginTop: size / RH(60),}}>
                    <Text style={{...font('bold', fontSizeTitle, WHITE), textAlign: 'center'}}>Создано игр</Text>
                    <Text style={font('bold', fontSizeCount, WHITE)}>{user.gamesCreated}</Text>
                </View>
                <View
                    style={{...style.titleBloc, width: size / RW(6), height: size / RH(14), marginTop: size / RH(60),}}>
                    <Text style={{...font('bold', fontSizeTitle, WHITE), textAlign: 'center'}}>Принято игр</Text>
                    <Text style={font('bold', fontSizeCount, WHITE)}>{user.acceptedGames}</Text>
                </View>
                <View
                    style={{...style.titleBloc, width: size / RW(6), height: size / RH(14), marginTop: size / RH(60),}}>
                    <Text style={{...font('bold', fontSizeTitle, WHITE), textAlign: 'center'}}>Отменено игр</Text>
                    <Text style={font('bold', fontSizeCount, WHITE)}>{user.canceledGames}</Text>
                </View>
                <View
                    style={{...style.titleBloc, width: size / RW(6), height: size / RH(14), marginTop: size / RH(60),}}>
                    <Text style={{...font('bold', fontSizeTitle, WHITE), textAlign: 'center'}}>Отклонено игр</Text>
