...
export const BoardGames = [
  {
    ...
    navigateTo: 'Elias',
    scheme: false,
    info:'Словесная игра “Элиас”. Командная игра в которой нужно объяснить как можно больше слов за определенное время, используя только синонимы, антонимы и мимику. Правилами запрещено давать объяснения по частям и на иностранных языках, а также недопустимо использование однокоренных слов.\n' +
        '\n' +
  ...
  },
  {
    ...
    info: 'Словесная игра «Крокодил». Цель и задачи – нужно показать загаданное слово, используя только жесты и мимику.\n' +
  ...
  },
  {
    ...
    scheme: false,
    navigateTo: 'Mafia',
    info:'Мафия захватывает мирный город, и честные жители больше не могут спать спокойно: им нужно вычислить кто есть кто и выгнать всю мафию, чтобы спастись. Если им не удастся это сделать, мафия захватит город, и мирные жители будут обречены.\n' +
  ...
  },
  {
    ...
    scheme: false,
    navigateTo: 'MyGame',
    info: 'Своя игра — это абсолютно любая игра, которая Вами может быть предложена. Для игры необходимо описать сюжет и правила либо, если она общепризнана, достаточно указать интернет-сайт с описанием этой игры.\n' +
        '\n' +
...
export const  ActiveGames = [
  {
    ...
    info:'Футбол — командный вид спорта, в котором целью является забить мяч в ворота соперника ногами или другими частями тела (кроме рук) большее количество раз, чем команда соперника. Команда, которая забьет больше голов к концу игры, становится победителем.\n' +
        '\n' +
  ...
  },
  {
    ...
    info: 'Хоккей – командная спортивная игра на льду, заключающаяся в противоборстве двух команд на коньках, которые, передавая шайбу клюшками, стремятся забросить её наибольшее количество раз в ворота соперника и не пропустить в свои.\n' +
        '\n' +
