      ...
      {isModalVisible ? null : (
        <ScrollView
          ...
          onScrollEndDrag={event =>
            +event.nativeEvent.contentOffset.x > data.length * (gadgetGame ? 240 : 300)
              ? onPressTouch(0)
              : +event.nativeEvent.contentOffset.x === 0
              ? onPressTouch(Games.length * 322)
              : null
          }
          horizontal={true}
          ...
          <View style={styles.body}>
            ...
            <View style={styles.btn}>
              <Button
                ...
                onPress={() => {
                  setModalVisible(false), setGadgetGame(true)
                }}
                label={'Да'}
              />
              <DarkButton
