    ...
    return (
        <ScreenMask>
            <View style={styles.container}>
                ...
                <View style={style.inputBlock}>
                    <TextInput onChangeText={(ev) => setSecondValue(ev)} placeholderTextColor={ICON} multiline={true}
                               numberOfLines={20} textAlignVertical={"top"} placeholder={'Сообщение'}
                               style={{...style.input, height: RH(405)}}/>
                ...
                <Modal modalVisible={isVisible} setIsVisible={setIsVisible}
                       item={
                           <View style={style.feedbackModal}>
                               <Text style={style.modalText}>Спасибо за ваше сообщение. В ближайшее время с вами
                                   свяжется менеджер приложения «Играем?».</Text>
                           </View>
                       }
                />
            </View>
