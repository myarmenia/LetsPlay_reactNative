...
const GameCreating = props => {
  ...
  return (
    <ScreenMask>
      <View>
        <Text style={{ ...style.titles, marginTop: RH(42), marginBottom: RH(16) }}>
        ...
        <ThirdBlock
          ...
          list={[
            { id: 1, text: '3:3', checked: true },
            { id: 3, text: '5:5', checked: false },
            { id: 4, text: '8:8', checked: false },
            { id: 5, text: '11:11', checked: false },
            { id: 6, text: 'Свой формат', checked: false },
          ]}
          title={'Формат игры'}
        />
        <FirstBlock
      ...
      <View style={{ marginTop: 'auto', marginLeft: 'auto', marginBottom: RH(20) }}>
        <Button
          onPress={() => navigation.navigate('SearchRes', { data })}
