...
const STEPS = [
    ...
    },
    {
        isLeft: true,
        isWrong: false,
        message: 'Подтвердите электронную почту. Вам на почту поступило письмо от  компании «Играем» с четырехзначным кодом. Укажите его здесь'
    },
    {
        isLeft: true,
        isWrong: false,
...
const SignUp = () => {
    ...
    return (
        <ScreenMask>
            <ScrollView style={{ flexDirection: 'column-reverse', flex: 1, paddingBottom: RH(94) }} showsVerticalScrollIndicator={false}>
