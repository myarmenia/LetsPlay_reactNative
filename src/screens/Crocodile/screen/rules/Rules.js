            ...
            item={
              <View style={styles.modalBody}>
                <View style={styles.modalRules}>
                  <Text style={styles.rulesText}>"Правила"</Text>
                  <Text style={styles.wordGame}>Словесная игра «Крокодил».</Text>
                  ...
                  <Text style={styles.wordGame}>
                    ...
                    первой команды получает загаданное слово и он должен показать его участникам
                    своей команды за определенное время. За угаданное слово команда получает 1 балл.
                  </Text>
                  <Text style={styles.wordGame}>
                    Далее показывает вторая команда. Выигрывает та команда, которая быстрее наберет
                    заранее определенное колличество баллов.
                  </Text>
                  <Text style={styles.wordGame}>
                    Количество игроков должно быть не менее 3 человек.
                  </Text>
                  <Text style={styles.wordGame}>Удачной игры!</Text>
                </View>
              </View>
            }
          />
