            ...
            <ScrollView>
                ...
                <View style={{marginLeft: RH(15)}}>
                    <View>
                        ...
                        <View style={styles.itemBlock}>
                            {guessed.map((item, i) =>
                                <View  key={i}><Text  key={i} style={styles.items}>{i + 1 + '. '}{item}</Text></View>
                            )}
                        </View>
                    </View>
                </View>
                <View style={styles.team}>
                    <View style={{marginLeft: RH(15)}}>
                        ...
                        {missed.map((item, i) =>
                            <View key={i}><Text style={styles.items}>{i + 1 + '. '}{item}</Text></View>
                        )}
                    </View>
                    <View style={{alignItems: 'center', marginTop:20}}>
                        <Button onPress={() => navigation.navigate('ResTeamsElias')} size={styles.btn}
                                label={'Продолжить'}/>
                    </View>
                </View>
            </ScrollView>
