...
const MafiaData = [
  ...
  },
  {
    ...
    title: 'Дон',
    text:
      'Глава клана Мафии. Определяет кого "убить" ночью после голосования мафии: видит, как голосовала мафии и может согласится с большинством в выборе жертвы, а может сделать свой выбор. Также, должен определить шерифа и обезвредить его, ведь шериф самый опасный персонаж  для Дона. И найти "крысу"  в своем клане - "Шпиона".',
    img:Don,
  },
  {
    id: 2,
