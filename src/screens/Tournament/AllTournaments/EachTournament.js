...
import { BACKGROUND, DARK_BLUE, ICON, LIGHT_LABEL, LIGHT_RED, RADIO_TEXT, WHITE } from '@/theme/colors'
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.propsWrapper}>
        <View style={styles.bigIcon}>
          <Image
            ...
            source={{ uri: _storageUrl + props?.img }}
          />
        </View>
        <View>
          ...
          <Text style={styles.eachInfoTwo}>
          Повседневная практика показывает, что укрепление и развитие структуры играет важную роль в формировании соответствующий условий активизации.
          </Text>
